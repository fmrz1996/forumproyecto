    ...
    <div class="card card-register mx-auto mt-5 mb-5">
      ...
      <div class="card-body">
        <form id="form" action="{{ url('admin/columnas/crear') }}" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}
          ...
          <div class="form-group">
            <div class="form-label-group">
              ...
              <textarea id="textBody" name="body" class="form-control" placeholder="Escribe un texto...">{{ old('body') }}</textarea>
            </div>
          </div>
          <button class="btn btn-primary btn-block" type="submit">Crear columna</button>
        </form>
      </div>
    </div>
  @endsection
